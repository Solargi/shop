    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                                ...
                                .requestMatchers(HttpMethod.GET, this.baseUrl + "/users/{userId}").access(this.userSecurity)
                                .requestMatchers(HttpMethod.PUT, this.baseUrl + "/users/{userId}").access(this.userSecurity)
                                .requestMatchers(HttpMethod.DELETE, this.baseUrl + "/users/{userId}**").access(this.userSecurity)

                                .requestMatchers(HttpMethod.GET, this.baseUrl + "/addresses/{addressId}").access(this.addressSecurity)
                                .requestMatchers(HttpMethod.POST, this.baseUrl + "/addresses/{userId}").access(this.userSecurity)
                                .requestMatchers(HttpMethod.PUT, this.baseUrl + "/addresses/{addressId}**").access(this.addressSecurity)
                                .requestMatchers(HttpMethod.DELETE, this.baseUrl + "/addresses/{addressId}**").access(this.addressSecurity)
                                ...
                                .requestMatchers(HttpMethod.GET, this.baseUrl + "/cartItems/{userId}/{itemId}").access(this.userSecurity)
                                .requestMatchers(HttpMethod.POST, this.baseUrl + "/cartItems/{userId}/{itemID}").access(this.userSecurity)
                                ...
                                .requestMatchers(HttpMethod.GET, this.baseUrl + "/orders/user/{userId}/**")
